...
def train(train_arr, test_arr,final_embeding):
    batch_size = 1
    nb_epochs = 500
    lr = 0.0001
    l2_coef = 0.0001
    ...
    model = GAT
    interaction, features, y_train, y_test, train_mask, test_mask, labels = load_data(train_arr, test_arr,final_embeding)
